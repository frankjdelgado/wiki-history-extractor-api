...
def calculate_v2(last_date,nth_date,amount_revisions):
	...
	print "> t1 =", last_date
	print "> t0 =", nth_date
	print "> n =", amount_revisions
	print "> E(x) = ", expected_value
	print "> Time Since Last Revision = ", time_since_last_revision
	...
	if time_since_last_revision > expected_value:
		print "> Result: The article shold be revisited"
		print ">>>> END <<<<"
		#print 'True'
		return True
	else:
		#print 'False'
		print "> Result: The article shold NOT be revisited"
		print ">>>> END <<<<"
		return False
def poisson(k, mean):
